...
urlpatterns=[
     ...
     path('take_app_view_m/',views.take_app_view_m,name='take_app_view_m'),
     ...
     path('foreign_visitors',views.foreign_visitors,name='foreign_visitors'),
     path('indian_visitors',views.indian_visitors,name='indian_visitors'),
